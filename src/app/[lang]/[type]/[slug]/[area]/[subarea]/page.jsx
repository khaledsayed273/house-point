...
export async function generateMetadata({ params, searchParams }) {
  ...
  try {
    ...
    return {
      ...
      alternates: {
        languages: {
          'x-default': `${mainUrl}/en/${params.type}/${params.slug}/${params.area}/${params.subarea}`,
          'ar': `${mainUrl}/ar/${params.type}/${params.slug}/${params.area}/${params.subarea}`,
        },
        types: {
  ...
  if (data?.status) {
    return (
      <>
        ...
        <meta
          property="og:url"
          content={`${mainUrl}/${params.lang}/${params.type}/${params.slug}/${params.area}/${params.subarea}`}
        />
        <link
          rel='canonical'
          href={`${mainUrl}/${params.lang}/${params.type}/${params.slug}/${params.area}/${params.subarea}`}
          key='canonical'
