...
function LanguageSwitcher({ translate,  lang }) {
    ...
    const arr = thePagePathName.split("/")
    ...
    return (
        <button className='flex items-center my-3 lg:my-0 text-custom-blue font-semibold hover:opacity-70' onClick={handleClick}>
