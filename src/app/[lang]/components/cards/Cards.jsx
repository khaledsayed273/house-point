            ...
            <div className='flex relative flex-col  bg-white rounded shadow-lg shadow-gray-300'>
                ...
                <div className='aspect-[3/2]'>
                    <div className='relative h-full w-full'>
                        ...
                        <div className="absolute top-0 start-0">
                            <h3 className='mt-3 text-sm font-bold px-3 py-1 rounded-e-md tracking-wider text-white transition-all bg-opacity-50 top-2 font-openSans bg-custom-blue'>
                                {item.category.name}
                            </h3>
                        </div>
                        {/* media */}
                        <MediaCards baseUrl={baseUrl} item={item} />
                        {/* bottom */}
                ...
                <div className='px-2 '>
                    ...
                    <div className='flex justify-between gap-2 my-1 text-sm'>
                        <span className='flex items-center justify-center w-full capitalize  gap-1 px-4 text-white rounded bg-custom-blue'>
